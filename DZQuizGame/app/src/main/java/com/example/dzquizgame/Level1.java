...
//        //=======================================================================================
        ...
        imgOne.setImageResource(array.images1[numOne]);

        //значения для второй картинки генерация
        do {
            numTwo = random.nextInt(12);
        } while (numOne == numTwo);
        imgTwo.setImageResource(array.images1[numTwo]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {// условие если картинку нажали
                    ...
                    if (count == 15) { //выход из уровня
                        ...
                        bal_l1 = count_right * 2;
                        textResult.setText("В этом задании Вы набрали " + bal_l1 + " баллов!\n Правильных ответов: " + count_right + "\n Неправильных ответов: " + count_loose);
                        ...
                        numOne = random.nextInt(12);
                        imgOne.setImageResource(array.images1[numOne]); //Достаем из массива картнку
                        imgOne.startAnimation(animation); //запускаем анимацию для левой картинки

                        do {
                            numTwo = random.nextInt(12);
                        } while (numOne == numTwo);
                        imgTwo.setImageResource(array.images1[numTwo]); //Достаем из массива картнку
