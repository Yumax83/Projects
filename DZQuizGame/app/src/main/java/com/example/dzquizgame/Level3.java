...
//вызов диалогового окна в начале игры
       ...
       previewImg.setImageResource(R.drawable.level3_main);

       TextView textDiscription = dialog.findViewById(R.id.text_description);
        textDiscription.setText(R.string.level_three);
...
//        dialogFon.setBackgroundResource(R.drawable.prev_lev_background_one);
      ...
      // dialogFonEnd.setBackgroundResource(R.drawable.prev_lev_background_one);
        ...
        descriptionEnd.setText(R.string.level_three_end);

        //интересный факт
        TextView textDescriptionEnd = dialogEnd.findViewById(R.id.text_description_end);
        textDescriptionEnd.setText(R.string.level_three_text_end);
        ...
        numOne = random.nextInt(15);
        imgOne.setImageResource(array.images3[numOne]);

        //значения для второй картинки генерация
        do {
            numTwo = random.nextInt(15);
        } while (numOne == numTwo);
        imgTwo.setImageResource(array.images3[numTwo]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {// условие если картинку нажали
                    ...
                    if (count == 15) { //выход из уровня
                        ...
                        bal_l3=count_right*4;
                        textResult.setText("В этом задании Вы набрали "+bal_l3+" баллов!\n Правильных ответов: "+ count_right + "\n Неправильных ответов: " + count_loose);
                        ...
                        numOne = random.nextInt(15);
                        imgOne.setImageResource(array.images3[numOne]); //Достаем из массива картнку
                        imgOne.startAnimation(animation); //запускаем анимацию для левой картинки

                        do {
                            numTwo = random.nextInt(15);
                        } while (numOne == numTwo);
                        imgTwo.setImageResource(array.images3[numTwo]); //Достаем из массива картнку
