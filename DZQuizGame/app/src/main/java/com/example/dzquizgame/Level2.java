...
//вызов диалогового окна в начале игры
       ...
       previewImg.setImageResource(R.drawable.chisla);

       TextView textDiscription = dialog.findViewById(R.id.text_description);
        textDiscription.setText(R.string.level_two);
...
//        dialogFon.setBackgroundResource(R.drawable.prev_lev_background_one);
      ...
      // dialogFonEnd.setBackgroundResource(R.drawable.prev_lev_background_one);
        ...
        descriptionEnd.setText(R.string.level_two_end);

        //интересный факт
        TextView textDescriptionEnd = dialogEnd.findViewById(R.id.text_description_end);
        textDescriptionEnd.setText(R.string.level_two_text_end);
        ...
        imgOne.setImageResource(array.images2[numOne]);

        //значения для второй картинки генерация
        do {
            numTwo = random.nextInt(10);
        } while (numOne == numTwo);
        imgTwo.setImageResource(array.images2[numTwo]);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {// условие если картинку нажали
                    ...
                    if (count == 15) { //выход из уровня
                        ...
                        bal_l2=count_right*1;
                        textResult.setText("В этом задании Вы набрали "+bal_l2+" баллов!\n Правильных ответов: "+ count_right + "\n Неправильных ответов: " + count_loose);
                        ...
                        numOne = random.nextInt(10);
                        imgOne.setImageResource(array.images2[numOne]); //Достаем из массива картнку
                        imgOne.startAnimation(animation); //запускаем анимацию для левой картинки

                        do {
                            numTwo = random.nextInt(10);
                        } while (numOne == numTwo);
                        imgTwo.setImageResource(array.images2[numTwo]); //Достаем из массива картнку
