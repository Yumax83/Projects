...
//вызов диалогового окна в начале игры
       ...
       previewImg.setImageResource(R.drawable.level_river);

       TextView textDiscription = dialog.findViewById(R.id.text_description);
        textDiscription.setText(R.string.level_five);
...
//        dialogFon.setBackgroundResource(R.drawable.prev_lev_background_one);
      ...
      // dialogFonEnd.setBackgroundResource(R.drawable.prev_lev_background_one);
        ...
        descriptionEnd.setText(R.string.level_five_end);

        //интересный факт
        TextView textDescriptionEnd = dialogEnd.findViewById(R.id.text_description_end);
        textDescriptionEnd.setText(R.string.level_five_text_end);
        ...
        numOne = random.nextInt(11);
        imgOne.setImageResource(array.images5[numOne]);

        //значения для второй картинки генерация
        do {
            numTwo = random.nextInt(11);
        } while (numOne == numTwo);
        imgTwo.setImageResource(array.images5[numTwo]);
...
//                        }
                        ...
                        bal_l5=count_right*5;
                        textResult.setText("В этом задании Вы набрали "+bal_l5+" баллов!\n Правильных ответов: "+ count_right + "\n Неправильных ответов: " + count_loose);
                        ...
                        numOne = random.nextInt(11);
                        imgOne.setImageResource(array.images5[numOne]); //Достаем из массива картнку
                        imgOne.startAnimation(animation); //запускаем анимацию для левой картинки

                        do {
                            numTwo = random.nextInt(11);
                        } while (numOne == numTwo);
                        imgTwo.setImageResource(array.images5[numTwo]); //Достаем из массива картнку
